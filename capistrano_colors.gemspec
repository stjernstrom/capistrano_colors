...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "Rakefile", "lib/capistrano_colors/configuration.rb", "lib/capistrano_colors/logger.rb", "lib/capistrano_colors.rb", "Manifest", "capistrano_colors.gemspec"]
